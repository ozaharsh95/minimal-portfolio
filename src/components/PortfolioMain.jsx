        ...
        <div className="bento-grid">
          ...
          <section className="bento-card col-span-2 hero-card" id="about">
            ...
            <p className="hero-desc">
              Building premium, performance-first web platforms. Focused on
              modular architecture, intuitive design details, and reliable
          ...
          {/* Row 5: Contact links & Feedback Form */}
          <ContactBlock />
          <FeedbackForm />
        </div>
