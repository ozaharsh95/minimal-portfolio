...
import { MailIcon, GithubIcon, LinkedinIcon, TwitterIcon, ExternalIcon, CopyIcon, CheckIcon } from './Icons';
...
export default function ContactBlock() {
  ...
  return (
    <section className="bento-card contact-card" id="contact">
      ...
      <div className="contact-options">
        ...
        >
          ...
          <span className="copy-badge">
            ...
            <span style={{ marginLeft: '4px' }}>{emailCopied ? 'Copied' : 'Copy'}</span>
          </span>
        </div>
        ...
        <a 
          ...
          className="contact-link-block"
        >
          <span className="contact-icon"><TwitterIcon /></span>
          <div className="contact-info">
